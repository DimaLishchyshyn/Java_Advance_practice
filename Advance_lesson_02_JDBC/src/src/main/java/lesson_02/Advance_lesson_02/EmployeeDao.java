...
public class EmployeeDao {
	...
	private static String CREATE = "insert into employee(firstname, lastname) values (?,?)";
	private static String READ_BY_ID = "select * from employee where id=?";
	private static String UPDATE_BY_ID = "update employee set firstname=?, lastname=? where id=?";
